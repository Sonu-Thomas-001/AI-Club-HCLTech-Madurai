...
export const Python: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M14.5,13.25a2,2,0,0,1-2,2H11V11.75a2,2,0,0,1,2-2h3v2h-3A.25.25,0,0,0,12.75,12v.25H14.5m-5,0a2,2,0,0,1-2,2H6v-3.5a2,2,0,0,1,2-2h3v2H8a.25.25,0,0,0-.25.25V11h1.75a2,2,0,0,1,2,2ZM15,20H9a5,5,0,0,1-5-5V9A5,5,0,0,1,9,4h6a5,5,0,0,1,5,5v6a5,5,0,0,1-5,5Z"/></svg>
);
export const Tensorflow: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 15-3-3 3-3 3 3-3 3Zm0 0v6.5m-3-9.5-4-4 4-4m6 8 4-4-4-4m-3 15.5v-6.5"/></svg>
);
export const Pytorch: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7.5 13l4.5-4.5 4.5 4.5M12 3v13.5M4.5 13H12m7.5 0H12"/></svg>
);
export const Firebase: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4.53 15.03l7.47-7.47 7.47 7.47-3.735 3.735-3.735-3.735-3.735 3.735zM12 17.77l-1.83-1.83 1.83-1.83 1.83 1.83-1.83 1.83zM4.53 4.53l7.47 7.47 1.83-1.83-7.47-7.47zM21.36 6.36l-1.83 1.83-7.47-7.47 1.83-1.83z"/></svg>
);
export const OpenAI: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10.15 12c.38-.38.38-1 0-1.42l-4.24-4.24c-.38-.38-1-.38-1.42 0L2 8.79c-.38.38-.38 1 0 1.42l4.24 4.24c.38.38 1 .38 1.42 0l2.49-2.45zM13.85 12c-.38.38-.38 1 0 1.42l4.24 4.24c.38.38 1 .38 1.42 0L22 15.21c.38-.38.38-1 0-1.42l-4.24-4.24c-.38-.38-1-.38-1.42 0l-2.49 2.45zM12 13.85c.38-.38.38-1 0-1.42L9.55 10c-.19-.19-.44-.28-.71-.28s-.52.09-.71.28L3.89 14.24c-.38.38-.38 1 0 1.42l4.24 4.24c.38.38 1 .38 1.42 0L12 17.36l2.45-2.49c.38-.38.38-1 0-1.42L12 10.15c.38-.38.38-1 0-1.42L9.55 6.29c-.38-.38-1-.38-1.42 0L3.89 10.53c-.38.38-.38 1 0 1.42l4.24 4.24c.38.38 1 .38 1.42 0L12 13.85z"/></svg>
);
export const HuggingFace: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.5 16.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zM8.5 16.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0zM12 13.5c-1.5 0-2.5-1-2.5-2.5s1-2.5 2.5-2.5 2.5 1 2.5 2.5-1 2.5-2.5 2.5zM12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z"/></svg>
);
...
export const Lightbulb: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 18h6v-2a4 4 0 0 0-4-4V5a4 4 0 0 0-4 4v7a2 2 0 0 0 2 2z"></path><line x1="12" y1="22" x2="12" y2="18"></line></svg>
);
export const ChartBar: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M3 3v18h18"></path><path d="M7 12v4"></path><path d="M12 8v8"></path><path d="M17 4v12"></path></svg>
);
export const Robot: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="4" y="8" width="16" height="12" rx="2"></rect><path d="M4 14h16"></path><path d="M8 8V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v3"></path><path d="M9 16v-2"></path><path d="M15 16v-2"></path></svg>
);
...
export const BrainCircuit: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9.5 8.5a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0-5 0Z"/><path d="M2.5 11.5a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0-5 0Z"/><path d="M16.5 11.5a2.5 2.5 0 1 0 5 0 2.5 2.5 0 1 0-5 0Z"/><path d="M12 19.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 1 0 0 5Z"/><path d="M5 11.5A3.5 3.5 0 0 0 8.5 8"/><path d="M8.5 9a3.5 3.5 0 0 1 3.5-3.5"/><path d="M12 5.5A3.5 3.5 0 0 1 15.5 9"/><path d="M15.5 8A3.5 3.5 0 0 0 19 11.5"/><path d="m12 14.5-2.5 2.5"/><path d="m12 14.5 2.5 2.5"/><path d="m12 14.5-5.5-3"/><path d="m12 14.5 5.5-3"/></svg>
);
...
export const CalendarPlus: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/><path d="M10 16h4"/><path d="M12 14v4"/></svg>
);
